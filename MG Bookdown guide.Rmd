...
``` 
````
Another option is with HTML code which allows you more options.

````{verbatim}
<center>![](figures/NEOF.png){style="max-width: 200px; border-radius: 15px; border: 5px solid #333333"}</center>
````

- max-width: Setst the max width, the maximum width of the page of my bookdowns is 1000px. 
