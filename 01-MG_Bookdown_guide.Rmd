...
- Code: "JetBrains Mono" which can differentiat between `1, l, L, 0, o, and O`. (https://fonts.google.com/specimen/JetBrains+Mono?preview.text=1%20l).
...
```{css, eval=FALSE}
@import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono&family=Lexend&display=swap');
.book.font-family-1 {
